# -*- coding: utf-8 -*-
"""
Created on Sun Apr 20 16:30:09 2025
...
# App title
st.markdown("<h1 style='text-align: center;'>🔍 K-Means Clustering App with Iris Dataset 6531501132</h1>", unsafe_allow_html=True)
